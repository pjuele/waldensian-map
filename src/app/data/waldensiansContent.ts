const text = `
The __Waldensians__ (sometimes called _Waldenses_ or _Vadois_) are members of a Christian movement that originated in 12th-century France, the devotees of which sought to follow Christ in poverty and simplicity.   
...
const content = {
  title: "Who are the Waldensians?",
  subTitle: "Lux lucet in tenebris",
  text,
  images: [],
};
